<form id="loginform" action="<?php echo URL_PREFIX; ?>login/go/login" method="post">
	...
	<p>
		<strong>Not signed up?</strong> Get yourself an account in under a minute. All the cool kids have one.<br />
		<a href="<?php echo URL_PREFIX; ?>login/signup">Sign up now</a>
	</p>
