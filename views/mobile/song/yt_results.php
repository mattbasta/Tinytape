...
<div id="ssearch_sidecar" style="display:none;">
	...
	<div id="sc_thanks" style="display:none;">
		Thanks for that!<br />
		<a id="sc_add" href="/song/<?php echo view_manager::get_value('ID'); ?>?addtotape=" class="addtotape">Add to Tape</a>
	</div>
</div>
	...
	$('#sc_form').submit(function() {
		$.post(
			...
			function(data) {
				...
				g("sc_add").href = "<?php echo URL_PREFIX; ?>song/addtotape/<?php echo view_manager::get_value('ID'); ?>/" + data.instance;
				if(data.badge)
					badge(data.badge);
			}
		);
